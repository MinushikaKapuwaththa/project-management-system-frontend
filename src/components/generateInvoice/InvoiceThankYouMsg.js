...
const InvoiceThankYouMsg = () => (
    <View style={styles.titleContainer}>
      <Text style={styles.reportTitle}>
        Please be kind enough to draw the cheque in favor of “G3 Technologies (PVT) LTD” or deposit to the A/C below.
      </Text>
  
      <Text style={[styles.middle,{ marginTop: 5 }]}>A/C No : 0211 1000 1905</Text>
      ...
      <Text style={styles.reportTitle}>
        G3 Technologies (Pvt) Ltd, No 485/9/E, Mulleriyawa Road, Thalahena, Malabe.
      </Text>
